...
describe('UnreadThreadStore', function() {
  ...
  var FormsAppDispatcher;
  var UnreadThreadStore;
  var callback;

  beforeEach(function() {
    FormsAppDispatcher = require('../../dispatcher/FormsAppDispatcher');
    UnreadThreadStore = require('../UnreadThreadStore');
    callback = FormsAppDispatcher.register.mock.calls[0][0];
  });

  it('registers a callback with the dispatcher', function() {
    expect(FormsAppDispatcher.register.mock.calls.length).toBe(1);
  });
