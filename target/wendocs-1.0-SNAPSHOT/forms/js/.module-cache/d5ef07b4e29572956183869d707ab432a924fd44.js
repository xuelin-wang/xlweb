...
var Form = React.createClass({displayName: "Form",
  ...
  render: function() {
    ...
    var defaultUpdateDataFunc = function(data, updateId, updateVal) {
        data[updateId] = updateVal;
    }

    var processDataUpdate = function(updateId, updateVal, updateFunc) {
        var deltaState = {};
    ...
    var getHandleChangeFunc = function(id) {
        var f = function(val) {
            return processDataUpdate(id, val);
        };
        return f;
    };
