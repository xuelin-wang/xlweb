            ...
            $.ajax(
                {
                    ...
                    success:
                        function(result, textStatus, errorThrown){
                            if (asyncCallIds[thisId] > newCallId)
                              return;
                            if (component.props.hasOwnProperty('callback') && component.props.callback != undefined && component.props.callback != null) {
                                component.props.callback(result, textStatus, errorThrown);
                            }
                       }
                });
        }
