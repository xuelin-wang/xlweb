...
var TableField = React.createClass({displayName: "TableField",
  render: function() {
    ...
    var dataRowRenderer = function(row, index, rows, props)
    {
//         var thisColRenderer = function(col, colIndex, cols) {
//             var cell = cellRenderer(index, colIndex, col, props);
//             return (
...
//         );
        ...
        return (
          React.createElement("tr", {key: index, className: headerRowClassName}, 
              row.map(
                  function(col, colIndex, cols) {
                  return (
                  React.createElement("td", {key: colIndex, className: headerColumnClassName}, 
                  col
                  )
                  );
                  }
